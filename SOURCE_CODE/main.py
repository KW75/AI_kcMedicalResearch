...
def run_sr_launcher(provider: str = "", model: str = "") -> None:
    ...
    if _provider == "deepseek":
        print("\n" + "=" * 58)
        print("  ?嚙踝蕭?  WARNING: DeepSeek does NOT support vision API")
        print("=" * 58)
...
def handle_search_mode(provider: str, model: str, sub_mode: str = None) -> None:
    ...
    if sub_mode:
        ...
        try:
            ...
            print("\n  ?嚙踝蕭? No input received. Defaulting to Topic Search (1).")
            sub = "1"
...
def handle_writing_mode(
    ...
    # ?嚙?嚙?Track selection ?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?
    print("\n" + "=" * 60)
    print("  WRITING MODE")
    print("=" * 60)
    ...
    # ?嚙?嚙?Word limit ?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?
    ...
    # ?嚙?嚙?Instructions ?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?
