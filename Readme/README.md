...
Ollama (local) 	--provider ollama 	OLLAMA_HOST 	Free, auto-detects best model
...
When no OLLAMA_MODEL is set in .env, the tool automatically queries http://localhost:11434/api/tags and selects the largest non-embedding model. This prevents breakage when models are updated or changed.
...
# OLLAMA_MODEL=        # Leave empty for auto-detection (recommended)
...
Contributing
    ...
    Commit and push
    Create a pull request '@ | Set-Content "Readme\README.md" -Encoding UTF8
